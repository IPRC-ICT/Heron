...
test_shapes = [
            [1, [16, 224, 224, 3  , 64  , 7, 7, 2, 3, 1]],
            [1, [16, 56,  56, 64  , 64  , 1, 1, 1, 0, 1]],
            [3, [16, 56,  56, 64  , 64  , 3, 3, 1, 1, 1]],
            [4, [16, 56,  56, 64  , 256 , 1, 1, 1, 0, 1]],
            [2, [16, 56,  56, 256 , 64  , 1, 1, 1, 0, 1]],
            [1, [16, 56,  56, 256 , 128 , 1, 1, 2, 0, 1]],
            [4, [16, 28,  28, 128 , 128 , 3, 3, 1, 1, 1]],
            [1, [16, 56,  56, 256 , 512 , 1, 1, 2, 0, 1]],
            [4, [16, 28,  28, 128 , 512 , 1, 1, 1, 0, 1]],
            [3, [16, 28,  28, 512 , 128 , 1, 1, 1, 0, 1]],
            [1, [16, 28,  28, 512 , 256 , 1, 1, 2, 0, 1]],
            [6, [16, 14,  14, 256 , 256 , 3, 3, 1, 1, 1]],
            [1, [16, 28,  28, 512 , 1024, 1, 1, 2, 0, 1]],
            [6, [16, 14,  14, 256 , 1024, 1, 1, 1, 0, 1]],
            [5, [16, 14,  14, 1024, 256 , 1, 1, 1, 0, 1]],
            [1, [16, 14,  14, 1024, 512 , 1, 1, 2, 0, 1]],
            [3, [16, 7 ,  7 , 512 , 512 , 3, 3, 1, 1, 1]],
            [1, [16, 14,  14, 1024, 2048, 1, 1, 2, 0, 1]],
            [3, [16, 7 ,  7 , 512 , 2048, 1, 1, 1, 0, 1]],
            [2, [16, 7 ,  7 , 2048, 512 , 1, 1, 1, 0, 1]],
